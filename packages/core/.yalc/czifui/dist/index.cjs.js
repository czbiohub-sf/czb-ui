...
var fontCaps = function (fontSize) {
    return function (props) {
        ...
        return react.css(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n      ", "\n      text-transform: uppercase;\n    "], ["\n      ", "\n      text-transform: uppercase;\n    "])), themeToCss(caps[fontSize]));
    };
};
...
var Accordion = function (props) {
    ...
    var _b = React__default["default"].useState(false), expanded = _b[0], setExpanded = _b[1];
    var handleChange = function (panel) {
        return function (_event, isExpanded) {
            setExpanded(isExpanded ? panel : false);
        };
    };
    return (React__default["default"].createElement(StyledAccordion, { id: id, square: true, useDivider: useDivider, togglePosition: togglePosition, expanded: expanded === id, onChange: handleChange(id), "data-testid": "accordion" }, children));
};

var StyledAlert = styles.styled(material.Alert)(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
...
var Alert$1 = function (props) {
    return React__default["default"].createElement(StyledAlert, __assign({}, props));
};
...
function SvgIconPercentageSmall(props) {
  ...
  })), _rect$2 || (_rect$2 = /*#__PURE__*/React__namespace.createElement("rect", {
    x: 11.208,
    y: 1.024,
    width: 2.5,
    height: 14.402,
...
var StyledSvgIcon = styles.styled(material.SvgIcon, {
    ...
    return react.css(templateObject_5$d || (templateObject_5$d = __makeTemplateObject(["\n      ", "\n      ", "\n      ", "\n      ", "\n    "], ["\n      ", "\n      ", "\n      ", "\n      ", "\n    "])), sdsType !== "iconButton" && iconSize(props), sdsType === "static" && staticStyle(props), sdsType === "interactive" && interactive(props), sdsType === "button" && buttonStyle());
});
var StyledIcon = styles.styled("div")(templateObject_7$7 || (templateObject_7$7 = __makeTemplateObject(["\n  display: contents;\n"], ["\n  display: contents;\n"])));
...
var Icon = React.forwardRef(function Icon(_a, ref) {
    ...
    if ((sdsSize === "xs" || sdsSize === "s") && smallIcon) {
        return (React__default["default"].createElement(StyledIcon, { ref: ref },
            React__default["default"].createElement(StyledSvgIcon, { fillcontrast: "white", viewBox: "0 0 14 14", component: smallIcon, sdsSize: sdsSize, sdsType: sdsType, sdsIcon: sdsIcon })));
    }
    if ((sdsSize === "l" || sdsSize === "xl") && largeIcon) {
        return (React__default["default"].createElement(StyledIcon, { ref: ref },
            React__default["default"].createElement(StyledSvgIcon, { fillcontrast: "white", viewBox: "0 0 32 32", component: largeIcon, sdsSize: sdsSize, sdsType: sdsType, sdsIcon: sdsIcon })));
    }
...
var isActive = function (props) {
    var sdsType = props.sdsType;
    var colors = getColors(props);
    return react.css(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n    ", "\n  "], ["\n    ", "\n  "])), sdsType !== "tertiary" &&
...
var IconButton = React.forwardRef(function (props, ref) {
    return React__default["default"].createElement(StyledIconButton$2, __assign({}, props, { ref: ref }));
});

var Centered = styles.styled("div")(templateObject_1$A || (templateObject_1$A = __makeTemplateObject(["\n  flex: 1 1 auto;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"], ["\n  flex: 1 1 auto;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n"])));
var IconWrapper = styles.styled("div")(templateObject_2$l || (templateObject_2$l = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var iconSizes = getIconSizes(props);
    var spaces = getSpaces(props);
...
var StyledIconButton$1 = styles.styled(IconButton, {
    shouldForwardProp: function (prop) {
...
var Text = styles.styled("div")(templateObject_4$d || (templateObject_4$d = __makeTemplateObject(["\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n"])), fontBodyS$2, function (props) {
    var typography = getTypography(props);
...
var StyledBanner = styles.styled("div", {
...
var Banner = React.forwardRef(function Banner(props, ref) {
    ...
    var _b = React.useState(false), wasDismissed = _b[0], setWasDismissed = _b[1];
    ...
    return (React__default["default"].createElement(StyledBanner, __assign({ role: "banner", sdsType: sdsType, ref: ref }, rest),
        React__default["default"].createElement(Centered, null,
            React__default["default"].createElement(IconWrapper, null,
                React__default["default"].createElement(Icon, { sdsIcon: "infoCircle", sdsSize: "l", sdsType: "static" })),
            React__default["default"].createElement(Text, null, text)),
        dismissible && (React__default["default"].createElement(StyledIconButton$1, { bannerType: sdsType, sdsType: "tertiary", sdsSize: "small", onClick: handleClose },
            React__default["default"].createElement(Icon, { sdsIcon: "xMark", sdsSize: "s", sdsType: "iconButton" })))));
});

var sdsPropNames$4 = ["isAllCaps", "isRounded", "sdsStyle", "sdsType"];
var ButtonBase = styles.styled(material.Button, {
...
var RoundedButton = styles.styled(ButtonBase, {
    shouldForwardProp: function (prop) { return !sdsPropNames$4.includes(prop); },
...
var MinimalButton = styles.styled(material.Button, {
    shouldForwardProp: function (prop) { return !sdsPropNames$4.includes(prop); },
...
var PrimaryMinimalButton = styles.styled(MinimalButton)(templateObject_4$c || (templateObject_4$c = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), minimal$2);
var SecondaryMinimalButton = styles.styled(MinimalButton)(templateObject_5$a || (templateObject_5$a = __makeTemplateObject(["\n  ", "\n  color: #000;\n"], ["\n  ", "\n  color: #000;\n"])), minimal$2);
var StyledButton$1 = styles.styled(material.Button, {
    shouldForwardProp: function (prop) { return !sdsPropNames$4.includes(prop); },
...
var Button = React__default["default"].forwardRef(function (props, ref) {
    ...
    switch (true) {
        case sdsStyle === "rounded" && sdsType === "primary":
            return (React__default["default"].createElement(RoundedButton, __assign({ color: "primary", ref: ref, variant: "contained" }, propsWithDefault)));
        case sdsStyle === "rounded" && sdsType === "secondary":
            return (React__default["default"].createElement(RoundedButton, __assign({ color: "primary", ref: ref, variant: "outlined" }, propsWithDefault)));
        case sdsStyle === "square" && sdsType === "primary":
            return (React__default["default"].createElement(SquareButton, __assign({ color: "primary", ref: ref, variant: "contained" }, propsWithDefault)));
        case sdsStyle === "square" && sdsType === "secondary":
            return (React__default["default"].createElement(SquareButton, __assign({ color: "primary", ref: ref, variant: "outlined" }, propsWithDefault)));
        case sdsStyle === "minimal" && sdsType === "primary":
            return (React__default["default"].createElement(PrimaryMinimalButton, __assign({ color: "primary", ref: ref, variant: "text" }, propsWithDefault)));
        case sdsStyle === "minimal" && sdsType === "secondary":
            return (React__default["default"].createElement(SecondaryMinimalButton, __assign({ color: "primary", ref: ref, variant: "text" }, propsWithDefault)));
        default:
            return React__default["default"].createElement(StyledButton$1, __assign({}, propsWithDefault, { ref: ref }));
    }
});
 ...
 * @see https://v4.mui.com/components/buttons/
 */
var ButtonDropdown = React__default["default"].forwardRef(function (props, ref) {
    var icon = props === null || props === void 0 ? void 0 : props.icon;
    var sdsStyle = props === null || props === void 0 ? void 0 : props.sdsStyle;
    var sdsType = props === null || props === void 0 ? void 0 : props.sdsType;
    return (React__default["default"].createElement(Button, __assign({}, props, { endIcon: React__default["default"].createElement(Icon, { sdsIcon: "chevronDown", sdsSize: "s", sdsType: "button" }), sdsStyle: sdsStyle, ref: ref, sdsType: sdsType, startIcon: icon })));
});

var fontBodyXs$3 = fontBody("xs");
var doNotForwardProps$b = ["calloutTitle"];
var StyledCallout = styles.styled(material.Alert, {
...
var Callout = function (_a) {
    ...
    var _b = React.useState(dismissed), hide = _b[0], setHide = _b[1];
    ...
    var getIcon = function () {
        ...
        switch (intent) {
            case "success":
                return React__default["default"].createElement(Icon, { sdsSize: "l", sdsIcon: "checkCircle", sdsType: "static" });
            case "info":
                return React__default["default"].createElement(Icon, { sdsSize: "l", sdsIcon: "infoCircle", sdsType: "static" });
            default:
                return (React__default["default"].createElement(Icon, { sdsSize: "l", sdsIcon: "exclamationMarkCircle", sdsType: "static" }));
        }
    };
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(material.Grow, { in: !hide },
            React__default["default"].createElement(StyledCallout, __assign({ onClose: onClose ? handleClose : undefined, action: onClose ? (React__default["default"].createElement(IconButton, { onClick: handleClose, sdsSize: "small", sdsType: "tertiary", size: "large" },
                    " ",
                    React__default["default"].createElement(Icon, { sdsIcon: "xMark", sdsSize: "s", sdsType: "iconButton" }),
...
var StyledCheckbox = styles.styled(material.Checkbox)(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var colors = getColors(props);
    var iconSizes = getIconSizes(props);
...
function createStatusCss(props, status) {
    ...
    return react.css(templateObject_5$9 || (templateObject_5$9 = __makeTemplateObject(["\n    background-color: ", ";\n\n    .MuiChip-label {\n      color: ", ";\n    }\n  "], ["\n    background-color: ", ";\n\n    .MuiChip-label {\n      color: ", ";\n    }\n  "])), statusColors.light, statusColors.dark);
}
var statusToCss = {
    beta: beta,
    error: error$3,
...
var StyledChip = styles.styled(material.Chip, {
...
var Chip = function (props) {
    ...
    if (onDelete) {
        return React__default["default"].createElement(StyledChip, __assign({ deleteIcon: React__default["default"].createElement(iconsMaterial.Clear, null) }, props));
    }
    return React__default["default"].createElement(StyledChip, __assign({}, props));
};
...
var rounded$2 = function (props) {
    ...
    return react.css(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n    .", " {\n      border-radius: ", "px;\n      border: ", ";\n    }\n  "], ["\n    .", " {\n      border-radius: ", "px;\n      border: ", ";\n    }\n  "])), material.outlinedInputClasses.notchedOutline, corners === null || corners === void 0 ? void 0 : corners.l, borders === null || borders === void 0 ? void 0 : borders.gray[400]);
};
var error$2 = function (props) {
    var borders = getBorders(props);
    return react.css(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n    .", " {\n      border: ", ";\n    }\n  "], ["\n    .", " {\n      border: ", ";\n    }\n  "])), material.outlinedInputClasses.notchedOutline, borders === null || borders === void 0 ? void 0 : borders.error[400]);
};
var warning$2 = function (props) {
    var borders = getBorders(props);
    return react.css(templateObject_3$e || (templateObject_3$e = __makeTemplateObject(["\n    .", " {\n      border: ", ";\n    }\n  "], ["\n    .", " {\n      border: ", ";\n    }\n  "])), material.outlinedInputClasses.notchedOutline, borders === null || borders === void 0 ? void 0 : borders.warning[400]);
};
var disabledStyled$1 = function (props) {
    var borders = getBorders(props);
    var colors = getColors(props);
    return react.css(templateObject_4$a || (templateObject_4$a = __makeTemplateObject(["\n    .Mui-disabled {\n      .", " {\n        border: ", ";\n      }\n\n      .MuiInputAdornment-root svg {\n        color: ", ";\n      }\n\n      &:hover .", " {\n        border: ", ";\n      }\n    }\n  "], ["\n    .Mui-disabled {\n      .", " {\n        border: ", ";\n      }\n\n      .MuiInputAdornment-root svg {\n        color: ", ";\n      }\n\n      &:hover .", " {\n        border: ", ";\n      }\n    }\n  "])), material.outlinedInputClasses.notchedOutline, borders === null || borders === void 0 ? void 0 : borders.gray[300], colors === null || colors === void 0 ? void 0 : colors.gray[300], material.outlinedInputClasses.notchedOutline, borders === null || borders === void 0 ? void 0 : borders.gray[300]);
};
var StyledLabel$2 = styles.styled("label")(templateObject_5$8 || (templateObject_5$8 = __makeTemplateObject(["\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n"])), fontBodyM$1, function (props) {
    var typography = getTypography(props);
    var spacings = getSpaces(props);
    return "\n      font-family: ".concat(typography === null || typography === void 0 ? void 0 : typography.fontFamily, ";\n      margin-bottom: ").concat(spacings === null || spacings === void 0 ? void 0 : spacings.xxs, "px;\n      position: absolute;\n      overflow: hidden;\n      clip: rect(0 0 0 0);\n      height: 1px;\n      width: 1px;\n      margin: -1px; padding: 0; border: 0;\n    ");
});
var StyledSearchBase = styles.styled(material.TextField, {
    shouldForwardProp: function (prop) {
    ...
    var borders = getBorders(props);
    var colors = getColors(props);
    return react.css(templateObject_6$7 || (templateObject_6$7 = __makeTemplateObject(["\n      margin-top: ", "px;\n      margin-bottom: ", "px;\n      margin-right: ", "px;\n      min-width: 120px;\n      display: block;\n\n      .", " {\n        .", " {\n          border: ", ";\n        }\n      }\n\n      .", " {\n        padding: ", "px ", "px;\n        height: 34px;\n        box-sizing: border-box;\n        background-color: #fff;\n      }\n\n      .", ":hover\n        .", " {\n        border: ", ";\n      }\n\n      .", ".Mui-focused {\n        .", " {\n          border: ", ";\n        }\n\n        .", " svg {\n          color: ", ";\n        }\n      }\n\n      ", "\n      ", "\n      ", "\n      ", "\n    "], ["\n      margin-top: ", "px;\n      margin-bottom: ", "px;\n      margin-right: ", "px;\n      min-width: 120px;\n      display: block;\n\n      .", " {\n        .", " {\n          border: ", ";\n        }\n      }\n\n      .", " {\n        padding: ", "px ", "px;\n        height: 34px;\n        box-sizing: border-box;\n        background-color: #fff;\n      }\n\n      .", ":hover\n        .", " {\n        border: ", ";\n      }\n\n      .", ".Mui-focused {\n        .", " {\n          border: ", ";\n        }\n\n        .", " svg {\n          color: ", ";\n        }\n      }\n\n      ", "\n      ", "\n      ", "\n      ", "\n    "])), spacings === null || spacings === void 0 ? void 0 : spacings.m, spacings === null || spacings === void 0 ? void 0 : spacings.m, spacings === null || spacings === void 0 ? void 0 : spacings.xl, material.outlinedInputClasses.root, material.outlinedInputClasses.notchedOutline, borders === null || borders === void 0 ? void 0 : borders.gray[400], material.inputBaseClasses.inputSizeSmall, spacings === null || spacings === void 0 ? void 0 : spacings.xs, spacings === null || spacings === void 0 ? void 0 : spacings.l, material.outlinedInputClasses.root, material.outlinedInputClasses.notchedOutline, borders === null || borders === void 0 ? void 0 : borders.gray[500], material.outlinedInputClasses.root, material.outlinedInputClasses.notchedOutline, borders === null || borders === void 0 ? void 0 : borders.primary[400], material.inputAdornmentClasses.root, colors === null || colors === void 0 ? void 0 : colors.primary[400], sdsStyle === "rounded" && rounded$2(props), intent === "error" && error$2(props), intent === "warning" && warning$2(props), disabled && disabledStyled$1(props));
});
 ...
 */
var InputSearch = React.forwardRef(function InputSearch(props, ref) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(StyledLabel$2, { htmlFor: id }, label),
        React__default["default"].createElement(StyledSearchBase, __assign({ ref: ref, 
            // passed to mui Input
            InputProps: {
                endAdornment: (React__default["default"].createElement(material.InputAdornment, { position: "end" },
                    React__default["default"].createElement(IconButton, { "aria-label": "search-button", onClick: localHandleSubmit, sdsType: "secondary", size: "large" },
                        React__default["default"].createElement(Icon, { sdsIcon: "search", sdsSize: "s", sdsType: "interactive" })))),
...
var TextWrapper = styles.styled("span")(templateObject_3$d || (templateObject_3$d = __makeTemplateObject(["\n  ", "\n\n  ", "\n\n  ", "\n"], ["\n  ", "\n\n  ", "\n\n  ", "\n"])), fontBodyXs$2, function (props) {
    var _a;
...
var ColumnWrapper = styles.styled("span")(templateObject_4$9 || (templateObject_4$9 = __makeTemplateObject(["\n  ", "\n\n  ", "\n\n  ", "\n"], ["\n  ", "\n\n  ", "\n\n  ", "\n"])), fontBodyXs$2, function (props) {
    var colors = getColors(props);
    return "\n      color: ".concat(colors === null || colors === void 0 ? void 0 : colors.gray[500], ";\n    ");
}, disabledStyles);
styles.styled("div")(templateObject_5$7 || (templateObject_5$7 = __makeTemplateObject(["\n  width: 250px;\n"], ["\n  width: 250px;\n"])));
var StyledCheck = styles.styled(iconsMaterial.Check, {
 ...
 */
var MenuItem = React.forwardRef(function (props, _) {
    ...
    return (React__default["default"].createElement(StyledMenuItem$2, __assign({}, originalMenuItemProps, { disabled: disabled }),
        isMultiSelect && (
        // TODO (mlila): replace with sds InputCheckbox class once complete
        React__default["default"].createElement(StyledCheck, { selected: selected, color: "primary", disabled: disabled })),
        React__default["default"].createElement(ContentWrapper, null,
            React__default["default"].createElement(TextWrapper, { selected: selected, className: "primary-text", disabled: disabled }, children),
            column && React__default["default"].createElement(ColumnWrapper, { disabled: disabled }, column))));
});
...
var StyledMenuItem$1 = styles.styled(MenuItem)(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  width: 100%;\n  min-height: unset;\n  white-space: pre-wrap;\n\n  ", "\n"], ["\n  width: 100%;\n  min-height: unset;\n  white-space: pre-wrap;\n\n  ", "\n"])), function (props) {
    var count = props.count;
    if (count) {
        return "\n        .primary-text {\n          width: 100%;\n          display: flex;\n          justify-content: space-between;\n        }\n      ";
    }
});
var StyledMenuItemDetails = styles.styled("div")(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n"])), fontBodyXxs$1, function (props) {
    var colors = getColors(props);
    return "\n      color: ".concat(colors === null || colors === void 0 ? void 0 : colors.gray[500], ";\n      white-space: pre-wrap;\n    ");
});
var StyledMenuItemCount = styles.styled("span")(templateObject_3$c || (templateObject_3$c = __makeTemplateObject(["\n  ", "\n  text-align: right;\n  color: black;\n\n  ", "\n"], ["\n  ", "\n  text-align: right;\n  color: black;\n\n  ", "\n"])), fontBodyXs$4, function (props) {
    var spacings = getSpaces(props);
    return "\n      margin-left: ".concat(spacings === null || spacings === void 0 ? void 0 : spacings.m, "px;\n    ");
});
var StyledAutocomplete$1 = styles.styled(Autocomplete__default["default"], {
...
var InputBaseWrapper$1 = styles.styled("div", {
    shouldForwardProp: function (prop) { return !doNotForwardProps$9.includes(prop); },
...
var StyledMenuInputSearch$1 = styles.styled(InputSearch, {
    shouldForwardProp: function (prop) { return !doNotForwardProps$9.includes(prop); },
...
function DropdownMenu(props) {
    ...
    return (React__default["default"].createElement(StyledAutocomplete$1, __assign({ clearOnBlur: false, disableCloseOnSelect: disableCloseOnSelect, disablePortal: true, renderTags: renderTags, noOptionsText: noOptionsText, renderOption: renderOption, getOptionLabel: getOptionLabel, isOptionEqualToValue: isOptionEqualToValue, inputValue: inputValue, onInputChange: function (event, value, reason) {
        ...
        }, renderInput: function (params) { return (React__default["default"].createElement(InputBaseWrapper$1, { search: search },
            React__default["default"].createElement(StyledMenuInputSearch$1, __assign({ id: "location-search", label: "Search for a location", placeholder: "Search", ref: params.InputProps.ref, search: search, onChange: onInputChange, autoFocus: true, InputProps: __assign(__assign({ 
                    /**
                     * (thuang): Works with css caret-color: "transparent" to hide
                     * mobile keyboard
                     */
                    inputMode: search ? "text" : "none" }, params.InputProps.ref), { endAdornment: (React__default["default"].createElement(material.InputAdornment, { position: "end" },
                        React__default["default"].createElement(IconButton, { sdsType: "secondary" },
                            React__default["default"].createElement(Icon, { sdsIcon: "search", sdsSize: "s", sdsType: "interactive" })))), inputProps: params.inputProps }) }, InputBaseProps)))); } }, props)));
    ...
    function defaultRenderOption(optionProps, option, _a) {
        ...
        return (React__default["default"].createElement("li", __assign({}, optionProps),
            React__default["default"].createElement(StyledMenuItem$1, __assign({}, { component: "div" }, { isMultiSelect: multiple, selected: selected, count: option.count }),
                React__default["default"].createElement("div", null,
                    option.name,
                    option.details && (React__default["default"].createElement(StyledMenuItemDetails, null, option.details))),
                option.count && (React__default["default"].createElement(StyledMenuItemCount, { className: "menuItem-count" }, option.count)))));
    }
}
...
var StyledCounter = styles.styled("span", {
    shouldForwardProp: function (prop) { return !doNotForwardProps$8.includes(prop); },
...
var square = function (props) {
    ...
    var spacings = getSpaces(props);
    var icon = props.icon;
    return react.css(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n    border-radius: ", "px;\n    padding: ", ";\n\n    &:after {\n      border-radius: ", "px;\n    }\n  "], ["\n    border-radius: ", "px;\n    padding: ", ";\n\n    &:after {\n      border-radius: ", "px;\n    }\n  "])), corners === null || corners === void 0 ? void 0 : corners.m, icon
...
var StyledTag$1 = styles.styled(material.Chip, {
...
var Tag = function (props) {
    ...
    return React__default["default"].createElement(StyledTag$1, __assign({ tagColor: color }, props, { color: "primary" }));
};

var StyledTag = styles.styled(Tag)(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var spacings = getSpaces(props);
...
var TagFilter = function (props) {
    return React__default["default"].createElement(StyledTag, __assign({ deleteIcon: React__default["default"].createElement(iconsMaterial.Clear, null) }, props));
};

var StyledTagFilter = styles.styled(TagFilter)(templateObject_1$p || (templateObject_1$p = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var spacings = getSpaces(props);
...
function Chips(_a) {
    ...
    if (!multiple) {
        ...
        return React__default["default"].createElement(StyledTagFilter, { label: name_1, onDelete: onDelete });
    }
    return (React__default["default"].createElement(React__default["default"].Fragment, null, value.map(function (item) {
        var name = item.name;
        return (React__default["default"].createElement(StyledTagFilter, { key: name, label: name, onDelete: function () { return onDelete(item); } }));
    })));
}

var Wrapper$1 = styles.styled("div")(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  width: 150px;\n"], ["\n  width: 150px;\n"])));
var StyledPopper$1 = styles.styled(material.Popper)(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  & {\n    ", "\n\n    ", "\n  }\n"], ["\n  & {\n    ", "\n\n    ", "\n  }\n"])), fontHeaderXs, function (props) {
    var colors = getColors(props);
    var corners = getCorners(props);
    var shadows = getShadows(props);
    var spacings = getSpaces(props);
...
var StyledChipsWrapper = styles.styled("div")(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var spacings = getSpaces(props);
...
function ComplexFilter(_a) {
    ...
    var _l = React.useState(null), anchorEl = _l[0], setAnchorEl = _l[1];
    var _m = React.useState(getInitialValue()), value = _m[0], setValue = _m[1];
    var _o = React.useState(getInitialValue()), pendingValue = _o[0], setPendingValue = _o[1];
    React.useEffect(function () {
        onChange(value);
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(Wrapper$1, __assign({}, rest),
            React__default["default"].createElement(InputDropdownComponent, __assign({ label: label, onClick: handleClick, sdsStage: open ? "userInput" : "default" }, InputDropdownProps)),
            React__default["default"].createElement(StyledChipsWrapper, null,
                React__default["default"].createElement(Chips, { value: value, multiple: multiple, onDelete: handleDelete }))),
        React__default["default"].createElement(PopperComponent, { anchorEl: anchorEl, modifiers: [
                {
                    name: "offset",
                    options: {
                        offset: [0, 8],
            ...
            React__default["default"].createElement(base.ClickAwayListener, { onClickAway: handleClose },
                React__default["default"].createElement("div", null,
                    React__default["default"].createElement(DropdownMenu, __assign({ open: !!open, onClose: handleMenuSelectClose, search: search, multiple: multiple, value: (multiple ? pendingValue : value), onChange: handleChange, disableCloseOnSelect: multiple, options: options }, MenuSelectProps)))))));
...
var DialogContext = React.createContext({ sdsSize: "m" });
...
var StyledPaper = styles.styled(material.Paper, {
 ...
 */
var DialogPaper = React.forwardRef(function DialogPaper(props, ref) {
    return (React__default["default"].createElement(DialogContext.Consumer, null, function (_a) {
        var sdsSize = _a.sdsSize;
        return React__default["default"].createElement(StyledPaper, __assign({ sdsSize: sdsSize, ref: ref }, props));
    }));
});
...
var Dialog = React.forwardRef(function Dialog(props, ref) {
    ...
    var contextValue = React.useMemo(function () { return ({ sdsSize: sdsSize }); }, [sdsSize]);
    return (React__default["default"].createElement(DialogContext.Provider, { value: contextValue },
        React__default["default"].createElement(material.Dialog, __assign({ ref: ref, PaperComponent: PaperComponent }, rest))));
});

// (thuang): Please keep this in sync with the props used in `DialogActionsExtraProps`
var doNotForwardProps$5 = ["buttonPosition"];
var StyledDialogActions = styles.styled(material.DialogActions, {
...
var DialogActions = React.forwardRef(function DialogActions(props, ref) {
    return React__default["default"].createElement(StyledDialogActions, __assign({ ref: ref }, props));
});

var StyledDialogContent = styles.styled(material.DialogContent)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  padding: 0;\n"], ["\n  padding: 0;\n"])));
var templateObject_1$l;

var index = React.forwardRef(
/**
 * @see https://v4.mui.com/components/dialogs/
 */
function DialogContent(props, ref) {
    return React__default["default"].createElement(StyledDialogContent, __assign({ ref: ref }, props));
});

var StyledIconButton = styles.styled(IconButton)(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  position: absolute;\n\n  ", "\n"], ["\n  position: absolute;\n\n  ", "\n"])), function (props) {
    var spaces = getSpaces(props);
...
var CloseButton = React.forwardRef(function CloseButton(props, ref) {
    return (React__default["default"].createElement(DialogContext.Consumer, null, function (_a) {
        var sdsSize = _a.sdsSize;
        var size = SDS_SIZE_TO_COMPONENT_SIZE[sdsSize];
        var iconSize = SDS_SIZE_TO_ICON_SIZE[sdsSize];
        return (React__default["default"].createElement(StyledIconButton, __assign({ ref: ref, sdsType: "tertiary", sdsSize: size }, props),
            React__default["default"].createElement(Icon, { sdsIcon: "xMark", sdsSize: iconSize, sdsType: "iconButton" })));
    }));
});

var StyledDialogTitle = styles.styled(material.DialogTitle)(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  padding: 0;\n  ", "\n"], ["\n  padding: 0;\n  ", "\n"])), function (props) {
    var spaces = getSpaces(props);
    return "\n      margin-bottom: ".concat((spaces === null || spaces === void 0 ? void 0 : spaces.xl) || 0, "px;\n    ");
});
var Title = styles.styled(material.Typography)(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  ", "\n\n  color: black;\n"], ["\n  ", "\n\n  color: black;\n"])), fontHeaderXl);
var Subtitle$1 = styles.styled(material.Typography)(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  ", "\n\n  ", "\n"], ["\n  ", "\n\n  ", "\n"])), fontBodyXs$4, function (props) {
    var colors = getColors(props);
    return "\n      color: ".concat(colors === null || colors === void 0 ? void 0 : colors.gray[500], ";\n    ");
});
...
var DialogTitle = React.forwardRef(function DialogTitle(props, ref) {
    ...
    return (React__default["default"].createElement(StyledDialogTitle, __assign({ ref: ref }, rest), children || (React__default["default"].createElement(React__default["default"].Fragment, null,
        onClose && React__default["default"].createElement(CloseButton, { onClick: onClose }),
        React__default["default"].createElement(Title, null, title),
        React__default["default"].createElement(Subtitle$1, null, subtitle)))));
});

styles.styled("div")(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  width: 150px;\n"], ["\n  width: 150px;\n"])));
var StyledPopper = styles.styled(Popper__default["default"])(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  ", "\n\n  .MuiAutocomplete-popperDisablePortal {\n    position: relative;\n    width: 100% !important;\n  }\n\n  ", "\n"], ["\n  ", "\n\n  .MuiAutocomplete-popperDisablePortal {\n    position: relative;\n    width: 100% !important;\n  }\n\n  ", "\n"])), fontHeaderXs, function (props) {
    var colors = getColors(props);
    var corners = getCorners(props);
    var shadows = getShadows(props);
    var spacings = getSpaces(props);
...
var StyledButton = styles.styled(Button)(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var spacings = getSpaces(props);
...
function Dropdown(_a) {
    ...
    var _o = React.useState(getInitialValue()), value = _o[0], setValue = _o[1];
    var _p = React.useState([]), pendingValue = _p[0], setPendingValue = _p[1];
    React.useEffect(function () {
        onChange(value);
    }, [value]);
    React.useEffect(function () {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(InputDropdownComponent, __assign({ label: label, onClick: handleClick, sdsStage: open ? "userInput" : "default" }, InputDropdownProps, rest)),
        React__default["default"].createElement(PopperComponent, { open: open, modifiers: [
                {
                    name: "offset",
                    options: {
                        offset: [0, 8],
            ...
            React__default["default"].createElement(DropdownMenu, __assign({ open: true, search: search, onClose: handleClose, multiple: multiple, value: (multiple ? pendingValue : value), onChange: handleChange, disableCloseOnSelect: multiple, options: options }, MenuSelectProps)),
            buttons && (React__default["default"].createElement("div", null, buttonPosition === "left" ? (React__default["default"].createElement("div", null,
                React__default["default"].createElement(StyledButton, { onClick: handleClose, sdsStyle: "square", sdsType: "primary" }, "Apply"),
                React__default["default"].createElement(StyledButton, { onClick: handleCancel, sdsStyle: "square", sdsType: "secondary" }, "Cancel"))) : (React__default["default"].createElement("div", null,
                React__default["default"].createElement(StyledButton, { onClick: handleCancel, sdsStyle: "square", sdsType: "secondary" }, "Cancel"),
                React__default["default"].createElement(StyledButton, { onClick: handleClose, sdsStyle: "square", sdsType: "primary" }, "Apply"))))))));
    function handleClick(event) {
        if (multiple) {
            setPendingValue(value);
...
var StyledSlider = styles.styled(material.Slider)(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  ", "\n\n  ", "\n"], ["\n  ", "\n\n  ", "\n"])), fontBodyXxs$1, function (props) {
 ...
 */
var InputSlider = React.forwardRef(function (props, ref) {
    return React__default["default"].createElement(StyledSlider, __assign({ ref: ref }, props));
});

var sdsPropNames$2 = ["sdsStyle", "sdsStage", "sdsType", "intent", "hideLabel"];
var error = function (props) {
    var borders = getBorders(props);
    return react.css(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n    .MuiOutlinedInput-notchedOutline {\n      border: ", ";\n    }\n  "], ["\n    .MuiOutlinedInput-notchedOutline {\n      border: ", ";\n    }\n  "])), borders === null || borders === void 0 ? void 0 : borders.error[400]);
};
var warning = function (props) {
    var borders = getBorders(props);
    return react.css(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n    .MuiOutlinedInput-notchedOutline {\n      border: ", ";\n    }\n  "], ["\n    .MuiOutlinedInput-notchedOutline {\n      border: ", ";\n    }\n  "])), borders === null || borders === void 0 ? void 0 : borders.warning[400]);
};
var disabledStyled = function (props) {
    var borders = getBorders(props);
    return react.css(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n    .Mui-disabled {\n      .MuiOutlinedInput-notchedOutline {\n        border: ", ";\n      }\n      &:hover .MuiOutlinedInput-notchedOutline {\n        border: ", ";\n      }\n    }\n  "], ["\n    .Mui-disabled {\n      .MuiOutlinedInput-notchedOutline {\n        border: ", ";\n      }\n      &:hover .MuiOutlinedInput-notchedOutline {\n        border: ", ";\n      }\n    }\n  "])), borders === null || borders === void 0 ? void 0 : borders.gray[300], borders === null || borders === void 0 ? void 0 : borders.gray[300]);
};
var textArea = function (props) {
    var spacings = getSpaces(props);
    return react.css(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n    .MuiInputBase-multiline {\n      padding: ", "px;\n      > .MuiInputBase-inputMultiline {\n        padding: ", "px ", "px ", "px;\n        resize: both;\n      }\n    }\n  "], ["\n    .MuiInputBase-multiline {\n      padding: ", "px;\n      > .MuiInputBase-inputMultiline {\n        padding: ", "px ", "px ", "px;\n        resize: both;\n      }\n    }\n  "])), spacings === null || spacings === void 0 ? void 0 : spacings.xxs, spacings === null || spacings === void 0 ? void 0 : spacings.xxs, spacings === null || spacings === void 0 ? void 0 : spacings.m, spacings === null || spacings === void 0 ? void 0 : spacings.m);
};
var StyledLabel = styles.styled("label")(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  display: block;\n  ", "\n\n  ", "\n"], ["\n  display: block;\n  ", "\n\n  ", "\n"])), fontBodyS$2, function (props) {
    var typography = getTypography(props);
    var spacings = getSpaces(props);
    return "\n      font-family: ".concat(typography === null || typography === void 0 ? void 0 : typography.fontFamily, ";\n      margin-bottom: ").concat(spacings === null || spacings === void 0 ? void 0 : spacings.xxs, "px;\n    ");
});
var StyledInputBase = styles.styled(material.TextField, {
    shouldForwardProp: function (prop) {
 ...
 * @see https://v4.mui.com/components/text-fields/
 */
var InputText = React.forwardRef(function InputText(props, ref) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        !hideLabel && React__default["default"].createElement(StyledLabel, { htmlFor: id }, label),
        React__default["default"].createElement(StyledInputBase, __assign({ ref: ref, inputProps: inputProps, type: "text", multiline: sdsType === "textArea", minRows: sdsType === "textArea" ? 4 : 2, id: id, intent: intent, variant: "outlined", size: "small", placeholder: placeholder, sdsStage: hasValue ? "userInput" : "default", sdsType: sdsType, onChange: handleChange }, rest))));
});
...
var dashedStyle = function (props) {
    var border = getBorders(props);
    return react.css(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n    color: inherit;\n    border-bottom: ", ";\n\n    &:hover,\n    &:focus {\n      text-decoration: none;\n      border-bottom: ", ";\n    }\n  "], ["\n    color: inherit;\n    border-bottom: ", ";\n\n    &:hover,\n    &:focus {\n      text-decoration: none;\n      border-bottom: ", ";\n    }\n  "])), border === null || border === void 0 ? void 0 : border.link.dashed, border === null || border === void 0 ? void 0 : border.link.solid);
};
var StyledLink = styles.styled(material.Link, {
    shouldForwardProp: function (prop) {
    ...
    return react.css(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n      ", "\n      ", "\n    "], ["\n      ", "\n      ", "\n    "])), sdsStyle === "default" && defaultStyle(props), sdsStyle === "dashed" && dashedStyle(props));
});
...
var Link = React.forwardRef(function (props, ref) {
    ...
    return React__default["default"].createElement(StyledLink, __assign({}, props, { underline: underline, ref: ref }));
});

// (thuang): Please keep this in sync with the props used in `ListExtraProps`
var doNotForwardProps$4 = ["marginBotton", "ordered"];
var StyledList = styles.styled(material.List, {
...
var List = function (props) {
    ...
    return (React__default["default"].createElement(StyledList, __assign({ component: ordered ? "ol" : "ul", disablePadding: true }, props)));
};
...
var StyledListItem = styles.styled(material.ListItem, {
...
var ListItemLabel = styles.styled("span")(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  margin-right: 5px;\n\n  ", "\n"], ["\n  margin-right: 5px;\n\n  ", "\n"])), function (props) {
    var fontWeights = getFontWeights(props);
    return "\n      font-weight: ".concat(fontWeights === null || fontWeights === void 0 ? void 0 : fontWeights.semibold, ";\n    ");
});
...
var ListItem = function (props) {
    return React__default["default"].createElement(StyledListItem, __assign({ disableGutters: true }, props));
};

var fontHeaderM = fontHeader("m");
var StyledListSubheader = styles.styled(material.ListSubheader)(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  &.MuiListSubheader-root {\n    ", "\n\n    line-height: unset;\n    color: unset;\n\n    ", "\n  }\n"], ["\n  &.MuiListSubheader-root {\n    ", "\n\n    line-height: unset;\n    color: unset;\n\n    ", "\n  }\n"])), fontHeaderM, function (props) {
    var spacings = getSpaces(props);
...
var ListSubheader = function (props) {
    return React__default["default"].createElement(StyledListSubheader, __assign({ disableGutters: true }, props));
};

var fontBodyS = fontBody("s");
var StyledText = styles.styled("span")(templateObject_1$b || (templateObject_1$b = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var spacings = getSpaces(props);
    var typography = getTypography(props);
...
var StyledLoadingIndicator = styles.styled("div", {
    ...
    var sdsStyle = props.sdsStyle;
    var spacings = getSpaces(props);
    var style = react.css(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n      display: inline-flex;\n      align-items: center;\n      padding: ", "px;\n    "], ["\n      display: inline-flex;\n      align-items: center;\n      padding: ", "px;\n    "])), spacings === null || spacings === void 0 ? void 0 : spacings.xxs);
    return react.css(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n      ", "\n      ", "\n      ", "\n    "], ["\n      ", "\n      ", "\n      ", "\n    "])), style, sdsStyle === "minimal" && minimal(props), sdsStyle === "tag" && tag(props));
});
...
var LoadingIndicator = function (_a) {
    ...
    return (React__default["default"].createElement(StyledLoadingIndicator, { sdsStyle: sdsStyle },
        React__default["default"].createElement(Icon, { sdsIcon: "loading", sdsSize: "l", sdsType: "static" }),
        React__default["default"].createElement(StyledText, null, "Loading")));
};

var StyledMenu = styles.styled(material.Menu)(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  & {\n    .MuiMenu-paper {\n      ", "\n    }\n\n    .MuiList-padding {\n      padding: 0;\n    }\n  }\n"], ["\n  & {\n    .MuiMenu-paper {\n      ", "\n    }\n\n    .MuiList-padding {\n      padding: 0;\n    }\n  }\n"])), function (props) {
    var spacings = getSpaces(props);
    return "\n          padding: ".concat(spacings === null || spacings === void 0 ? void 0 : spacings.xs, "px;\n        ");
});
...
var Menu = function (props) {
    return (React__default["default"].createElement(StyledMenu, __assign({ anchorOrigin: ANCHOR_ORIGIN, transformOrigin: TRANSFORM_ORIGIN }, props)));
};

var StyledMenuItem = styles.styled(MenuItem)(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
...
var StyledAutocomplete = styles.styled(material.Autocomplete, {
...
var InputBaseWrapper = styles.styled("div", {
    shouldForwardProp: function (prop) { return !doNotForwardProps$1.includes(prop); },
...
var StyledMenuInputSearch = styles.styled(InputSearch, {
    shouldForwardProp: function (prop) { return !doNotForwardProps$1.includes(prop); },
})(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  && {\n    margin: 0;\n\n    .", " {\n      width: 100%;\n      padding: 0;\n      padding-right: 14px !important;\n    }\n\n    /* (thuang): Works with attribute inputMode: \"none\" to hide mobile keyboard */\n    caret-color: ", ";\n  }\n"], ["\n  && {\n    margin: 0;\n\n    .", " {\n      width: 100%;\n      padding: 0;\n      padding-right: 14px !important;\n    }\n\n    /* (thuang): Works with attribute inputMode: \"none\" to hide mobile keyboard */\n    caret-color: ", ";\n  }\n"])), material.inputBaseClasses.root, function (_a) {
    var search = _a.search;
    return (search ? "auto" : "transparent");
});
...
function MenuSelect(props) {
    ...
    return (React__default["default"].createElement(StyledAutocomplete, __assign({ clearOnBlur: false, open: true, disableCloseOnSelect: disableCloseOnSelect, disablePortal: true, renderTags: renderTags, noOptionsText: noOptionsText, renderOption: renderOption, getOptionLabel: getOptionLabel, inputValue: inputValue, onInputChange: function (event, value, reason) {
        ...
        }, renderInput: function (params) { return (React__default["default"].createElement(InputBaseWrapper, { search: search },
            React__default["default"].createElement(StyledMenuInputSearch, __assign({ id: "location-search", label: "Search for a location", placeholder: "Search", ref: params.InputProps.ref, search: search, autoFocus: true, InputProps: __assign(__assign({ 
                    /**
                     * (thuang): Works with css caret-color: "transparent" to hide
                     * mobile keyboard
                     */
                    inputMode: search ? "text" : "none" }, params.InputProps.ref), { endAdornment: (React__default["default"].createElement(material.InputAdornment, { position: "end" },
                        React__default["default"].createElement(IconButton, { sdsType: "secondary", size: "large" },
                            React__default["default"].createElement(Icon, { sdsIcon: "search", sdsSize: "s", sdsType: "interactive" })))), inputProps: params.inputProps }) }, InputBaseProps)))); } }, props)));
    function defaultGetOptionLabel(option) {
        if (typeof option === "object" && "name" in option)
            return option.name;
    ...
    function defaultRenderOption(optionProps, option, _a) {
        var selected = _a.selected;
        return (React__default["default"].createElement(StyledMenuItem, __assign({}, { component: "li" }, { isMultiSelect: multiple, selected: selected }, optionProps), option.name));
    }
}

var fontBodyXs = fontBody("xs");
var StyledNotification = styles.styled(material.Alert)(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n"])), fontBodyXs, function (props) {
    var colors = getColors(props);
    var spacings = getSpaces(props);
    var shadows = getShadows(props);
    var _a = props.severity, severity = _a === void 0 ? "success" : _a;
...
var Notification = function (_a) {
    ...
    var _c = React.useState(dismissed), hide = _c[0], setHide = _c[1];
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(material.Slide, { in: !hide, direction: dismissDirection, mountOnEnter: true, unmountOnExit: true, timeout: 250 },
            React__default["default"].createElement(StyledNotification, __assign({ onClose: onClose ? handleClose : undefined, action: onClose ? (React__default["default"].createElement(IconButton, { onClick: handleClose, sdsSize: "small", sdsType: "tertiary", "data-testid": "notificationCloseButton", size: "large" },
                    " ",
                    React__default["default"].createElement(Icon, { sdsIcon: "xMark", sdsSize: "s", sdsType: "iconButton" }),
                    " ")) : null, icon: getIcon(), className: "elevated", severity: intent }, passedProps),
                children,
                buttonOnClick && (React__default["default"].createElement(Button, { sdsStyle: "minimal", sdsType: "secondary", onClick: buttonOnClick }, buttonText))))));
};
...
var StyledRadioButton = styles.styled(material.Radio)(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var colors = getColors(props);
    var iconSizes = getIconSizes(props);
    return "\n      color: ".concat(colors === null || colors === void 0 ? void 0 : colors.gray[400], ";\n      &:hover {\n        color: ").concat(colors === null || colors === void 0 ? void 0 : colors.gray[500], ";\n        background-color: transparent;\n      }\n      &.Mui-disabled {\n        color: ").concat(colors === null || colors === void 0 ? void 0 : colors.gray[300], ";\n      }\n      &.Mui-checked {\n        color: ").concat(colors === null || colors === void 0 ? void 0 : colors.primary[400], ";\n        &:hover {\n          color: ").concat(colors === null || colors === void 0 ? void 0 : colors.primary[500], ";\n          background-color: transparent;\n        }\n        &.Mui-disabled {\n          color: ").concat(colors === null || colors === void 0 ? void 0 : colors.primary[300], "\n        }\n      }\n\n      .MuiSvgIcon-root {\n        height: ").concat(iconSizes === null || iconSizes === void 0 ? void 0 : iconSizes.input.height, "px;\n        width: ").concat(iconSizes === null || iconSizes === void 0 ? void 0 : iconSizes.input.width, "px;\n      }\n    ");
});
...
var RadioButton = function (props) {
    ...
    return (React__default["default"].createElement(StyledRadioButton, __assign({}, newProps, { checkedIcon: React__default["default"].createElement(material.SvgIcon, { fillcontrast: "white", component: SvgIconRadioChecked, viewBox: "0 0 16 16" }), icon: React__default["default"].createElement(material.SvgIcon, { fillcontrast: "white", component: SvgIconRadioUnchecked, viewBox: "0 0 16 16" }) })));
};

var dark = function (props) {
    var spacings = getSpaces(props);
    return css.css(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n    ", "\n    background-color: black;\n    color: white;\n    text-align: center;\n    max-width: 250px;\n    padding: ", "px ", "px;\n  "], ["\n    ", "\n    background-color: black;\n    color: white;\n    text-align: center;\n    max-width: 250px;\n    padding: ", "px ", "px;\n  "])), fontHeaderXs(props), spacings === null || spacings === void 0 ? void 0 : spacings.s, spacings === null || spacings === void 0 ? void 0 : spacings.l);
};
var light = function (props) {
    var spacings = getSpaces(props);
    return css.css(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n    ", "\n    background-color: white;\n    color: black;\n    text-align: left;\n    max-width: 250px;\n    padding: ", "px ", "px;\n  "], ["\n    ", "\n    background-color: white;\n    color: black;\n    text-align: left;\n    max-width: 250px;\n    padding: ", "px ", "px;\n  "])), fontBodyXs$4(props), spacings === null || spacings === void 0 ? void 0 : spacings.xs, spacings === null || spacings === void 0 ? void 0 : spacings.l);
};
var wide = function () {
    return css.css(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n    max-width: 550px;\n  "], ["\n    max-width: 550px;\n  "])));
};
var tableStyles = function (props) {
    var spacings = getSpaces(props);
    return css.css(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n    padding: ", "px;\n  "], ["\n    padding: ", "px;\n  "])), spacings === null || spacings === void 0 ? void 0 : spacings.m);
};
var Subtitle = styles.styled("div")(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  ", "\n\n  ", "\n"], ["\n  ", "\n\n  ", "\n"])), fontHeaderXxs, function (props) {
    var colors = getColors(props);
    return "\n      color: ".concat(colors === null || colors === void 0 ? void 0 : colors.gray["400"], ";\n    ");
});
...
var Tooltip = React.forwardRef(function Tooltip(props, ref) {
    ...
    return (React__default["default"].createElement(material.Tooltip, __assign({ classes: { arrow: arrow, tooltip: tooltip }, leaveDelay: leaveDelay, title: content, ref: ref }, rest)));
});
...
var StyledSegmentedControl = styles.styled(ToggleButtonGroup__default["default"], {
...
var SegmentedControl = function (props) {
    ...
    var _b = React__default["default"].useState(leftmost), active = _b[0], setActive = _b[1];
    var handleActive = function (event, newActive) {
        if (newActive !== null) {
            setActive(newActive);
        }
    };
    return (React__default["default"].createElement(StyledSegmentedControl, __assign({ color: "primary", size: "small", value: active, exclusive: true, onChange: handleActive }, props),
        buttonDefinition.map(function (button) {
            var iconName = button.iconName, tooltipText = button.tooltipText;
            return (React__default["default"].createElement(ToggleButton__default["default"], { disableRipple: true, value: tooltipText, key: tooltipText },
                React__default["default"].createElement(Tooltip, { title: tooltipText, sdsStyle: "dark", arrow: true },
                    React__default["default"].createElement("span", null,
                        React__default["default"].createElement(Icon, { sdsIcon: iconName, sdsSize: "s", sdsType: "button" })))));
        }),
        ";"));
};

var TabsContext = React.createContext({ sdsSize: "large" });

var Wrapper = styles.styled("span")(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) {
    var colors = getColors(props);
    return "\n      &:active {\n        color: black;\n      }\n\n      &:disabled {\n        color: ".concat(colors === null || colors === void 0 ? void 0 : colors.gray[200], ";\n      }\n    ");
});
var LABEL_DO_NOT_FORWARD_PROPS = ["sdsSize"];
var Label = styles.styled("span", {
    shouldForwardProp: function (prop) {
...
var LabelWithCount = React.forwardRef(function LabelWithCount(props, ref) {
    var _a = React.useContext(TabsContext).sdsSize, sdsSize = _a === void 0 ? "large" : _a;
    var label = props.label, count = props.count;
    return (React__default["default"].createElement(Wrapper, { ref: ref },
        React__default["default"].createElement(Label, { sdsSize: sdsSize }, label),
        React__default["default"].createElement(Count, { sdsSize: sdsSize }, count)));
});

var TempTabs = function (props) { return React__default["default"].createElement(material.Tabs, __assign({}, props)); };
var TABS_DO_NOT_FORWARD_PROPS = ["underlined", "sdsSize"];
var StyledTabs = styles.styled(TempTabs, {
    shouldForwardProp: function (prop) {
...
var StyledTab = styles.styled(material.Tab, {
...
var TabIndicator = function (theme) {
    ...
    return css.css(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n    &.MuiTabs-indicator {\n      background-color: ", ";\n      height: 2px;\n      bottom: -2px;\n      z-index: 2;\n    }\n  "], ["\n    &.MuiTabs-indicator {\n      background-color: ", ";\n      height: 2px;\n      bottom: -2px;\n      z-index: 2;\n    }\n  "])), colors === null || colors === void 0 ? void 0 : colors.primary[400]);
};
var Tabs = React.forwardRef(function Tabs(props, ref) {
    ...
    var contextValue = React__default["default"].useMemo(function () { return ({ sdsSize: sdsSize }); }, [sdsSize]);
    var indicatorProps = React.useMemo(function () {
        return { className: TabIndicator(theme) };
    }, [theme]);
    return (React__default["default"].createElement(TabsContext.Provider, { value: contextValue },
        React__default["default"].createElement(StyledTabs, __assign({ TabIndicatorProps: indicatorProps, ref: ref }, rest))));
});
/**
...
var Tab = React.forwardRef(function Tab(props, ref) {
    ...
    count === undefined ? (label) : (React__default["default"].createElement(LabelWithCount, { label: label, count: count }));
    return React__default["default"].createElement(StyledTab, __assign({ label: Label, ref: ref }, rest, context));
});
 ...
 * https://mui.com/components/tooltips/#disabled-elements
 */
var TooltipCondensed = React.forwardRef(function TooltipCondensed(props, ref) {
    ...
    return (React__default["default"].createElement(Tooltip, { followCursor: true, placement: "right-end", enterDelay: 50, leaveDelay: 50, title: title, ref: ref, classes: { tooltip: tooltip } }, children));
});
...
var Section = styles.styled("div")(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  ", "\n\n  ", "\n"], ["\n  ", "\n\n  ", "\n"])), disabledStyle, function (props) {
    var colors = getColors(props);
    var spacings = getSpaces(props);
...
var SectionLabel = styles.styled("div")(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  ", "\n  ", "\n\n  ", "\n"], ["\n  ", "\n  ", "\n\n  ", "\n"])), fontCapsXxxxs, disabledStyle, function (props) {
    var colors = getColors(props);
    var spacings = getSpaces(props);
    if (!props.label)
        return "";
...
var RowLabel = styles.styled(material.TableCell, {
    shouldForwardProp: function (prop) {
        return !sdsPropNames.includes(prop.toString());
    },
})(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  ", "\n  ", "\n\n  padding: 0;\n  width: 50%;\n"], ["\n  ", "\n  ", "\n\n  padding: 0;\n  width: 50%;\n"])), fontHeaderXs, disabledStyle);
var RowValue = styles.styled(material.TableCell, {
    shouldForwardProp: function (prop) {
        return !sdsPropNames.includes(prop.toString());
    },
})(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  ", "\n  ", "\n\n  padding-top: 0;\n  padding-bottom: 0;\n  padding-right: 0 !important;\n"], ["\n  ", "\n  ", "\n\n  padding-top: 0;\n  padding-bottom: 0;\n  padding-right: 0 !important;\n"])), fontBodyXs$4, disabledStyle);
var Alert = styles.styled("div")(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), fontBodyXxs$1);
...
var TooltipTableContent = function (props) {
    ...
    return (React__default["default"].createElement(material.TableContainer, __assign({}, rest),
        contentAlert && React__default["default"].createElement(Alert, null, contentAlert), data === null || data === void 0 ? void 0 :
        data.map(function (section) { return (React__default["default"].createElement(Section, { disabled: section.disabled, key: "".concat(section.label) },
            React__default["default"].createElement(SectionLabel, { disabled: section.disabled, label: section.label }, section.label),
            React__default["default"].createElement(material.Table, { size: "small" },
                React__default["default"].createElement(material.TableBody, null, section.dataRows.map(function (row) { return (React__default["default"].createElement(material.TableRow, { key: row.label },
                    React__default["default"].createElement(RowLabel, { disabled: section.disabled, align: "left" }, row.label),
                    React__default["default"].createElement(RowValue, { disabled: section.disabled, align: itemAlign }, row.value))); }))))); })));
};
...
exports.Chip = Chip;
exports.ComplexFilter = ComplexFilter;
exports.ComplexFilterInputDropdown = InputDropdown;
exports.ComplexFilterPopper = StyledPopper$1;
exports.Dialog = Dialog;
exports.DialogActions = DialogActions;
exports.DialogContent = index;
exports.DialogContext = DialogContext;
exports.DialogPaper = DialogPaper;
exports.DialogTitle = DialogTitle;
exports.DialogTitleSubtitle = Subtitle$1;
exports.DialogTitleTitle = Title;
exports.Dropdown = Dropdown;
exports.DropdownInputDropdown = InputDropdown;
exports.DropdownMenu = DropdownMenu;
exports.DropdownPopper = StyledPopper;
exports.Icon = Icon;
...
exports.TooltipCondensed = TooltipCondensed;
exports.TooltipTable = TooltipTableContent;
exports.defaultAppTheme = defaultAppTheme;
exports.defaultTheme = defaultTheme;
exports.fontBody = fontBody;
exports.fontBodyL = fontBodyL$1;
exports.fontBodyM = fontBodyM$1;
exports.fontBodyS = fontBodyS$2;
exports.fontBodyXs = fontBodyXs$4;
exports.fontBodyXxs = fontBodyXxs$1;
exports.fontBodyXxxs = fontBodyXxxs$1;
exports.fontCaps = fontCaps;
exports.fontCapsXxs = fontCapsXxs;
exports.fontCapsXxxs = fontCapsXxxs;
exports.fontCapsXxxxs = fontCapsXxxxs;
exports.fontHeader = fontHeader;
exports.fontHeaderL = fontHeaderL;
exports.fontHeaderM = fontHeaderM$1;
exports.fontHeaderS = fontHeaderS;
exports.fontHeaderXl = fontHeaderXl;
exports.fontHeaderXs = fontHeaderXs;
exports.fontHeaderXxl = fontHeaderXxl;
exports.fontHeaderXxs = fontHeaderXxs;
exports.fontHeaderXxxs = fontHeaderXxxs;
...
exports.getSpacings = getSpacings;
exports.getTypography = getTypography;
exports.makeThemeOptions = makeThemeOptions;
